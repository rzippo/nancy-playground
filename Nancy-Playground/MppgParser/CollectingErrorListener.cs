...
public sealed class DiagnosticParserErrorListener : BaseErrorListener
{
    ...
    /// </summary>
    /// <remarks>
    /// ANTLR quotes the span from the start of the alternative to the token it stopped at, taken from the tokens, so <c>( floor comp</c> comes out as <c>(floorcomp</c>; see the messages of [Parr13] §9.1.
